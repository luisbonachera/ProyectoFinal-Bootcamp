...
CREATE TABLE `tipoidentificacion` (
  `IdTipoIdentificacion` tinyint(4) NOT NULL AUTO_INCREMENT,
  `TipoIdentificacion` char(12) NOT NULL,
...
INSERT INTO `tipoidentificacion` VALUES (1,'DNI'),(2,'NIE'),(3,'PASAPORTE');
...
-- Dump completed on 2019-07-17 20:09:50
