...
CREATE TABLE `sports_center` (
  ...
  `numbers_court` tinyint(5) NOT NULL DEFAULT '1',
...
INSERT INTO `sports_center` VALUES (1,'Centro Deportivo UMA','Málaga','El Consul',3,5,3),(2,'Club Deportivo Vals','Málaga','El Consul',3,6,3),(3,'Centro Deportivo Limoneros','Puerto de la Torre','El Limonero',2,5,3),(4,'Club de Tenis Puente Romano','Marbella','Puente Romano',10,12,5);
...
-- Dump completed on 2019-08-07  0:14:36
