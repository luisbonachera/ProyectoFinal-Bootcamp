...
import { CardDeck, Card, DropdownButton, Dropdown, Form, Col } from 'react-bootstrap';
                ...
                <div className="barraFiltros" style={{ display: 'flex', flexDirection: 'row' }}>
                    ...
                    <div className="form-group row">
                        ...
                        <div className="col-sm-10">
                            <input type="text" className="form-control" id="inputUsername" placeholder="username" onChange={UpdateUsername}/>
                        </div>
                    </div>
                    <div className="form-group row">
                        <label className="col-sm-2 col-form-label"></label>
                        <div className="col-sm-10">
                            <input type="text" className="form-control" id="inputCity" placeholder="City" onChange={UpdateCity}/>
                        </div>
                    </div>
